---
layout: "post"
title: "Neustart für den Blog mit DragonTD"
---
...
Seit ein paar Wochen arbeite ich nun an einem neuen privaten Projekt: einem Tower-Defense-Spiel namens [DragonTD (dragontd.de)](https://dragontd.de). Mit diesem Projekt, meinem vierten Spiel, möchte ich auch meinen Blog wiederbeleben und künftig vor allem über die Entwicklung und die technischen Erkenntnisse daraus schreiben.

<!--more-->

DragonTD begann als kleine Tech-Demo an einem Wochenende, ausgelöst durch den Release der Codex App und einige Runden Bloons TD 6, die zusammengenommen bei mir direkt Lust geweckt haben, so etwas selbst auszuprobieren.

Danach war das erste Ziel, innerhalb der ersten Woche eine spielbare Version zu bauen. Diese Version kann man sich hier anschauen: [DragonTD v1.0](https://releases.dragontd.de/v1.0/).
